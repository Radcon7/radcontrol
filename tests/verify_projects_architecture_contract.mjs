...
assert.match(model, /launchLabel: project\.operatorUrl \|\| project\.launchUrl \? "Launch Radcon Portal" : "Launch Localhost"/);
...
assert.match(app, /await ensureLaunchHost\(latest\)/);
