...
assert.match(view, /testId=\{`legal-\$\{record\.key\}-node`\}/);
assert.match(view, /legal-townhouse-node/);
assert.match(view, /legal-portal-access-diagram/);
assert.match(view, /legal-ownership-connector-radcon/);
assert.match(view, /legal-support-connector-radcon/);
assert.match(view, /legal-portal-access-connector/);
...
assert.match(css, /\.legalGraphConnector/);
assert.match(css, /\.legalGraphConnectorSupport/);
assert.match(css, /border-top: 2px dashed/);
