...
assert.match(bridge, /"codex\.memory\.status"/);
assert.match(bridge, /"lesson\.candidate\.list\."/);
assert.doesNotMatch(bridge, /"lesson\.candidate\.promote/);
assert.doesNotMatch(bridge, /"lesson\.candidate\.capture/);
