...
export function buildInfrastructureProfiles(projects: ProjectRow[]): InfrastructureProfile[] {
  ...
  return [
    ...
    },
    {
      ...
      environmentScope: "local",
      primaryConsoleUrl: "",
      focusSummary: "Diagnose the primary development machine, identify project-owned stale work, and keep a bounded local record of health checks and safe cleanup.",
      statusAuditFocus: "Review temperature, fan, load, memory, disk, pressure, local services, containers, workspace breadth, and governed cleanup candidates.",
      mcpApiPosture: "O2 now provides local health, history, safe-cleanup, and bounded Terra-review actions. No external monitoring API or scheduled agent is used.",
      ...
      statusSummary: "Manual zero-token health checks and safe cleanup are live; Terra medium participates only when explicitly requested.",
      relatedProjectKeys: ["radcontrol", ...defaultProjectKeys],
    },
    {
